...
const ProductCard = ({title, price = 100, discount = 0 , image}) => {
  return (
    <div className="w-[240px] h-[400px] bg-white border border-gray-200 rounded-lg shadow-md p-4 m-2">
      {/* Discount Badge */}
      ...
      {/* Product Name */}
      <h3 className="text-sm text-center font-semibold text-gray-800 mb-3">
        {title}
      </h3>
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex flex-col">
          <span className="text-sm font-bold text-gray-800">₹ {(price - discount*price/100).toFixed(2)}</span>
